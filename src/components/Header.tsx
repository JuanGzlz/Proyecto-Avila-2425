...
const Header: React.FC = () => {
  ...
  return (
    <header className="header !shadow-md">
      <div className="container hidden h-[100px] w-full mx-auto px-6 md:flex justify-between items-center">
        <motion.button 
        ...
        <nav className="nav">
          ...
          <>
            ...
            <button className="nav-link !bg-transparent hover:!bg-white hover:!text-#1d6363 text-#1d6363 px-4 py-2 rounded transition" onClick={() => navigate('/ventana-reserva')}>Reservas</button>
